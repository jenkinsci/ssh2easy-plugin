...
public class GsshFtpUploadBuilder extends Builder {
    ...
    public GsshFtpUploadBuilder(
            boolean disable, String serverInfo, String localFilePath, String remoteLocation, String fileName) {
            ...
            if (localFilePath != null && remoteLocation != null) {
                ...
                if (path.exists() && path.isDirectory()) {
                    for (FilePath f : path.list()) {
                        exitStatus =
                                sshClient.uploadFile(logger, uploadFileName, new File(f.getRemote()), remoteLocation);
                    }
                } else {
